...
const Footer = () => {
  return (
    <div className='rounded-div mt-8 pt-8 text-primary'>
            ...
            <div className='w-full md:w-[300px] py-4 relative'>
              ...
              <div className='py-4'>
                <form>
                  ...
                  <button className='bg-button text-white px-4 p-2 w-full rounded-2xl shadow-xl hover:shadow-2xl md:w-auto my-2'>Sign up</button>
                </form>
              </div>
      ...
      <p className='text-center py-2'>Designed with ❤ by Christian</p>
